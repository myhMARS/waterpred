      ...
      <table class="w-full min-w-full">
        ...
        <tr>
          ...
          <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
            ...
            >
              <div class="flex items-center gap-3">
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">市</p>
              </div>
          ...
          <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
            ...
            >
              <div class="flex items-center gap-3">
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">区</p>
              </div>
              <span class="flex flex-col gap-0.5">
                  <svg
                      class="fill-gray-300 dark:fill-gray-700"
          ...
          <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
            ...
            >
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">气温(℃)</p>
              <span class="flex flex-col gap-0.5">
                  <svg
                      class="fill-gray-300 dark:fill-gray-700"
                      width="8"
          ...
          <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
            ...
            >
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">湿度(%)</p>
              <span class="flex flex-col gap-0.5">
                  <svg
                      class="fill-gray-300 dark:fill-gray-700"
                      width="8"
          ...
          <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
            <div
                class="flex items-center justify-between w-full cursor-pointer"
                @click="sortBy('winddirection')"
            >
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">风向</p>
              <span class="flex flex-col gap-0.5">
                  <svg
                      class="fill-gray-300 dark:fill-gray-700"
                      width="8"
          ...
          <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
            <div
                class="flex items-center justify-between w-full cursor-pointer"
                @click="sortBy('windpower')"
            >
              <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">风速(m/s)</p>
              <span class="flex flex-col gap-0.5">
                  <svg
                      class="fill-gray-300 dark:fill-gray-700"
                      width="8"
        ...
        >
          ...
          <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            <a class="block font-medium text-gray-800 text-theme-sm dark:text-white/90"
               :href="`/area/${area.county}`">
              {{ area.county }}
            </a>
          </td>

          <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ area.times }}</p>
          </td>
          <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ area.temperature }}</p>
          </td>
          <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ area.humidity }}</p>
          </td>
          <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ area.winddirection }}</p>
          </td>
          <td class="px-4 py-3 border border-gray-100 dark:border-gray-800">
            <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ area.windpower }}</p>
          </td>
        </tr>
        </tbody>
      </table>
...
const filteredData = computed(() => {
  ...
  return data.value
      .filter(
          (area) =>
              String(area.city).toLowerCase().includes(searchLower) ||
