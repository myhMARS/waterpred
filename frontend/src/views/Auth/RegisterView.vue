                ...
                <div class="space-y-5">
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      <label
                          for="user_id"
                          class="mb-1.5 block text-md font-medium text-gray-700 dark:text-gray-400"
                      >
                        工号<span class="text-error-500">*</span>
                      </label>
                      <input
                          v-model="user_id"
                          type="text"
                  ...
                  <div>
                    <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                      手机号<span class="text-error-500">*</span>
                    </label>
                    <input
                        v-model="phone"
                        type="text"
